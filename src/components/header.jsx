            ...
            <div className="relative">
              ...
              {isLoginOptionsOpen && (
                <div className="absolute -right-5 mt-4 w-48 px-2 text-center bg-[#11292956] backdrop-blur-lg rounded shadow-lg z-50 transition-all duration-300 ease-in-out">
                  <ul className="py-2">
                    <li>
                      <Link to="/freelancer-login" className="block px-4 py-2 border-b-1 border-[#37f9a277]" onClick={toggleLoginOptions}>
                        Login as Freelancer
                      </Link>
                    </li>
                    <li>
                      <Link to="/client-login" className="block px-4 py-2" onClick={toggleLoginOptions}>
                        Login as Client
                      </Link>
                    </li>
                  </ul>
