      ...
      <div className="w-full flex flex-col lg:flex-row justify-between lg:mt-10 mt-30 p-5 lg:p-30 bg-gradient-to-b from-[#060E0E] to-[#83ff9812]">
        <div className="lg:w-1/2 mb-10 lg:mb-0">
          ...
          <div className="flex gap-4">
            <button className="bg-[#2cef80] text-black px-5 py-3 rounded-md font-medium">
              Get a Service
            </button>
            <button className="border border-[#2cef80] text-white px-5 py-3 rounded-md font-medium">
              Get a Guy
            </button>
          </div>
        </div>

        <div className="lg:w-1/2 lg:flex justify-center items-center hidden">
          <div className="relative rounded-lg overflow-hidden border border-[#2cef80]/30 shadow-lg shadow-[#2cef80]/10">
            <img
              src="./MacBook Pro 14_ - 23.png"
              alt="Project Form Interface"
      ...
      <div className="w-full lg:mt-20 mt-15">
        <div className="container mx-auto px-5 lg:px-20">
          <div className="flex flex-col lg:flex-row justify-between items-center lg:pb-16 pb-5">
            ...
            <div className="mt-6 lg:mt-0 lg:w-1/4 flex justify-end">
              <div className="flex gap-6">
                <a href="#" className="text-gray-400 hover:text-[#2cef80]">
                  <svg
          ...
          <div className="border-t border-gray-800 pt-4 pb-8 text-center">
            <p className="text-gray-500">©Krip.ai, All rights reserved</p>
          </div>
        </div>
      </div>
    </div>
